...
function MangaList({ title, manga }) {
  ...
  return (
    <div className="text-white p-6 mb-6 bg-gradient-to-r from-gray-900 via-black to-gray-900 rounded-xl shadow-lg">
      <h2 className="uppercase text-3xl font-extrabold mb-4 text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
        {title}
      </h2>
      <Carousel
          ...
          >
            ...
            >
              <Link
                ...
                className="px-6 py-2 bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold rounded-lg hover:from-blue-500 hover:to-green-400"
              >
                Read Manga
              </Link>
            </div>
